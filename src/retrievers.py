"""
Retrieval systems for memory search and indexing.

This module provides both hybrid (BM25 + semantic) and pure semantic
retrieval systems for finding related memories.
"""
...
class HybridRetriever:
    ...
    def load(cls, retriever_cache_file: str, retriever_cache_embeddings_file: str):
        ...
        if Path(retriever_cache_embeddings_file).exists():
    ...
    def load_from_local_memory(cls, memories: Dict, model_name: str, alpha: float):
        """Load retriever state from memory dictionary."""
